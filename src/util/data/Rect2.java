...
public class Rect2 {
     ...
     */
    public void inset(Rect2 insets) {
        left += insets.left;
        top += insets.top;
        right -= insets.right;
     ...
     *              rectangle
     */
    public boolean contains(Rect2 r) {
        // check for empty first
        return this.left < this.right && this.top < this.bottom
                // now check for containment
     ...
     * intersection, use {@link #intersects(Rect2, Rect2)}.
     *
     ...
     *              return false and do not change this rectangle.
     */
    public boolean intersect(Rect2 r) {
     ...
     */
    public boolean setIntersect(Rect2 a, Rect2 b) {
     ...
     * use {@link #intersect(Rect2)} or {@link #setIntersect(Rect2, Rect2)}.
     *
     ...
     */
    public static boolean intersects(Rect2 a, Rect2 b) {
