...
//            }
    ...
    private static void formatting() {
        ...
        data = "【末世梵音：超脫脈輪之理】[8/20-8/26]\n" +
                "\n" +
                "★ 第一彈：每天登入魔法石\n" +
                "時間：8 月 20 日 (一) 至 8 月 26 日 (日)\n" +
                "活動期間登入遊戲，每天可得魔法石 1 粒，共可獲 7 粒。\n" +
                "\n" +
                "★ 第二彈：登入送好禮\n" +
                "時間：8 月 20 日 (一) 至 8 月 26 日 (日)\n" +
                "於 8 月 20 日維護後至 8 月 26 日登入遊戲，\n" +
                "可獲得『印度神』系列封印卡隨機 1 隻 (技能等級 1)；\n" +
                "於 8 月 24 日登入遊戲，可獲得「人面雛鳥」3 隻；\n" +
                "於 8 月 25 日登入遊戲，可獲得「戰賞點」1000 點；\n" +
                "於 8 月 26 日登入遊戲，可獲得「背包容量」10 格。\n" +
                "\n" +
                "★ 第三彈：魔法石封印卡活動『七色脈輪』\n" +
                "時間：8 月 20 日 (一) 至 10 月 1 日 (一)\n" +
                "活動期間開放『七色脈輪』抽卡選項，當中包含 8 位『印度神』系列角色。\n" +
                "『七色脈輪』可於『商店』內找到。\n" +
                "『印度神』系列包括：\n" +
                "5 星「濕婆」\n" +
                "5 星「梵天」\n" +
                ...
                "5 星「阿耆尼」\n" +
                "5 星「伐樓尼」\n" +
                "進行『七色脈輪』抽卡選項時，每 35 抽必中 5 星角色「梵天」\n" +
                "\n" +
                "★ 第四彈：地獄級關卡『朱翼降臨』\n" +
                "時間：8 月 24 日 (五) 22:00 至 8 月 26 日 (日) 23:59\n" +
                "吸盡眼前的火炎，噬火鳥神的拼死掙扎！\n" +
                "＊成功挑戰三星成就，將獲得稀有龍刻獎賞\n" +
                "＊成功通關 3 次，可獲得「燃熠比翼 ‧ 迦樓羅」動態造型\n" +
                "\n" +
                "★ 第五彈：致勝的泉源\n" +
                "時間：8 月 25 日 (六) 至 8 月 26 日 (日)\n" +
                "活動期間登入可獲得體力回復劑 1 支 (必須於活動期間使用)。\n" +
                "＊召喚師可於星期六或日登入並於 [社群] → [獎賞] 內領取。\n" +
                "＊此獎賞使用期限為 8 月 25 日 (六) 至 8 月 26 日 (日)。\n" +
                "\n" +
                "★ 第六彈：儲值送好禮\n" +
                "時間：8 月 20 日 (一) 至 8 月 26 日 (日)\n" +
                "只要在活動期間首次單筆儲值魔法石 6 粒或以上(不論之前是否曾儲值），\n" +
                "可額外獲得『印度神』系列封印卡隨機一張，獲得之封印卡必定為技能等級 7 。\n" +
                "同時，召喚師可獲贈「瘋頭」 1 隻。每位召喚師最多只會得到獎賞一次。\n" +
                "例：8 月 20 日購買魔法石 6 粒，額外的獎勵可於重登後在 [獎賞] 內領取。\n" +
                "8 月 21 日再次購買魔法石 6 粒，將不會再次獲得相同獎賞。\n" +
                "＊ 8 月 31 日 (下星期五) 將推出『七色脈輪』魔法石封印特別活動，屆時獲得『印度神』稀有角色的機率會大幅提升\n" +
                "＊ 活動優惠適用於所有已安裝《神魔之塔》的 iOS 及 Android (Google Play 與 APK) 版本玩家\n" +
                "\n" +
                "★ 第七彈：主線任務突進！\n" +
                "時間：8 月 20 日 (一) 起\n" +
                "等了很久了嗎？全新主線任務即將登場！\n" +
                "率先面臨的將會是恐怖巨獸「墜落殺戮 ‧ 貝西摩斯」與其帶領的群魔異獸！\n" +
                "\n" +
                "★ 第八彈：特別活動『初轉脈輪』\n" +
                "時間：8 月 20 日 (一) 至 8 月 26 日 (日)\n" +
                "感受脈輪之力，您有領悟神力的資質嗎？\n" +
                "\n" +
                "★ 第九彈：儲值活動『月賞滿載』\n" +
                "時間： 8 月 20 日 (一) 至 9 月 2 日 (日)\n" +
                "活動期間將推出新一期「月禮包」儲值方案！召喚師可藉此獲得大量魔法石與抽卡機會！\n" +
                "註：\n" +
                "此活動同時適用於 iOS 及 Android(Google Play 與 APK) 遊戲版本。\n" +
                "此禮包抽卡機率不受任何抽卡活動影響。\n" +
                "凡購買「月禮包」將可同時觸發「儲值送好禮」，並獲得『印度神』系列封印卡隨機一張及其餘相關獎賞。\n" +
                "\n" +
                "★ 第十彈：特別活動『熱玩2018電競展』\n" +
                "時間： 8 月 24 日 (五) 至 8 月 26 日 (日)\n" +
                "慶祝神魔參展『香港電競音樂節 2018』，將連續三天設下福利關卡讓你狂刷！\n" +
                "＊首次通過關卡，即可獲得「夢覺涼夏 ‧ 喀耳刻」泳裝造型\n" +
                "\n" +
                "★ 第十一彈：『印度神』及『巴比倫主神』系列強化合成效果提升\n" +
                "時間：8 月 20 日 (一) 至 9 月 16 日 (日)\n" +
                "活動期間，指定系列進行強化合成時，必定獲得超絕或完美強化！\n" +
                "\n" +
                "★ 第十二彈：儲值活動『冒險者的禮包』\n" +
                "時間：8 月 20 日 (一) 至 10 月 1 日 (一)\n" +
                "嬴在起跑點！再推全新限定禮包，助你快速成長！\n" +
                "本次版本將帶來 3 款新手禮包，切勿錯過超值優惠！\n" +
                "禮包方案包括：\n" +
                "1) 冒險禮包 ($8)\n" +
                "– 每位召喚師限購 5 次\n" +
                "-「斯芬克斯」5 隻\n" +
                ...
                "註：\n" +
                "此活動同時適用於 iOS 及 Android(Google Play 與 APK) 遊戲版本。\n" +
                "凡購買「歷練禮包」及「傳奇禮包」將可同時觸發「儲值送好禮」，並獲得『印度神』系列封印卡隨機一張及其餘相關獎賞。\n" +
                "\n" +
                "★ 第十三彈：特別活動『靈魂獲得提升』\n" +
                "時間：8 月 20 日 (一) 至 9 月 9 日 (日)\n" +
                "活動期間，以『印度神』系列角色進行分解時，獲得的靈魂數將會大幅提升！\n" +
                "\n" +
                "★ 第十四彈：『奧羅茲遺族』系列任務再續\n" +
                "神秘的遺族陸續登場，逐漸走近歷史的真相！\n" +
                "開放關卡：『幽禁之籠牢』\n" +
                "時間：8 月 20 日 (一) 至 9 月 9 日 (日)\n" +
                "註:\n" +
                "1.『幽禁之籠牢』關卡設有精英級難度，成功通過後關卡 BOSS 100% 掉落！\n" +
                "精英級的開放條件為擁有該王關角色，並成功通過超級難度關卡。\n" +
                "精英級關卡將不設成就及排行榜。\n" +
                "系列關卡設有「指定場次獎勵」，通關達指定次數後可獲額外獎賞。\n" +
                "\n" +
                "★ 第十五彈：『行商要塞』新品上架\n" +
                "時間：8 月 20 日 (一) 至 10 月 1 日 (一)\n" +
                "行商要塞貨品再上架，經過不要錯過！\n" +
                "\n" +
                "★ 追加活動：累計簽到賞\n" +
                "時間：8 月 21 日 (二) 至 10 月 2 日 (二)\n" +
                "合作活動期間，只要成功累計簽到滿 14 天，召喚師將可額外獲得\n" +
                "全新角色「六臂爐兵」1 隻 (滿等；滿技)！\n" +
                "＊每位召喚師只會獲得特別獎勵一次\n";

        data = "【黑暗料理肆虐】[8/27-9/2]\n" +
                "★ 第一彈：每天登入魔法石\n" +
                "\n" +
                "時間：8 月 27 日 (一) 至 8 月 31 日 (五)\n" +
                "\n" +
                ...
                "★ 第二彈：公會任務『新手廚娘上路』\n" +
                "\n" +
                "時間：8 月 27 日 (一) 至 9 月 2 日 (日)\n" +
                "\n" +
                "暗黑料理上桌，小心吃到肚子劇痛喔！\n" +
                "\n" +
                "詳情請參閱：https://towerofsaviors.com/2018/08/22/%E5%85%AC%E6%9C%83%E4%BB%BB%E5%8B%99%E3%80%8E%E7%98%8B%E8%87%A8%E8%8C%B6%E5%B1%85%E3%80%8F/\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第三彈：地獄級『樹幹間的風』及『隕落的星耀』\n" +
                "\n" +
                "時間：8 月 31 日 (五) 22:00 至 9 月 2 日 (日) 23:59\n" +
                "\n" +
                " \n" +
                "\n" +
                "同時開放關卡：\n" +
                ...
                "『樹幹間的風』\n" +
                "\n" +
                "崇尚和平的妖族王者，小心被牽涉於牠因愛成怒的恐怖反擊！\n" +
                "\n" +
                "『隕落的星耀』\n" +
                "\n" +
                "無能為力的感悟，召喚師一起找出隱居的獵人！\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第四彈：致勝的泉源\n" +
                "\n" +
                "時間：9 月 1 日 (六) 至 9 月 2 日 (日)\n" +
                "\n" +
                "活動期間登入可獲得體力回復劑 1 支 (必須於活動期間使用)。\n" +
                "\n" +
                " \n" +
                ...
                "＊召喚師可於星期六或日登入並於 [社群] → [獎賞] 內領取。\n" +
                "\n" +
                "＊此獎賞使用期限為 9 月 1 日 (六) 至 9 月 2 日 (日)。\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第五彈：魔法石封印活動『脈輪運轉』\n" +
                ...
                "時間：8 月 31 日 (五)\n" +
                "\n" +
                "活動當日於『七色脈輪』封印中，獲得稀有角色的機率將大幅提升！\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第六彈：『印度神』稀有角色動態造型出場\n" +
                "\n" +
                "時間：8 月 31 日 (五) 至 10 月 1 日 (一)\n" +
                "\n" +
                "活動期間，以下稀有角色動態造型登場！\n" +
                "\n" +
                " \n" +
                "\n" +
                "於以下卡匣進行抽卡動作，可獲「唯識無境 ‧ 梵天」動態造型！\n" +
                "\n" +
                "指定封印卡匣包括：\n" +
                "\n" +
                "『魔法石銘之封印（上）』\n" +
                ...
                "★ 第七彈：復刻任務『死物附靈』系列\n" +
                "\n" +
                "時間：8 月 27 日 (一) 至 10 月 7 日 (日)\n" +
                "\n" +
                "於活動期間，『死物附靈』系列關卡將逐週開放，同時系列角色掉落率獲得提升！\n" +
                "\n" +
                "關卡開放時間：\n" +
                "\n" +
                "『物靈附身 ‧ 水』－8 月 27 日 (一) 至 9 月   9 日 (日) \n" +
                "『物靈附身 ‧ 火』－9 月   3 日 (一) 至 9 月 16 日 (日)\n" +
                "\n" +
                "『物靈附身 ‧ 木』－9 月 10 日 (一) 至 9 月 23 日 (日)\n" +
                "\n" +
                "『物靈附身 ‧ 光』－9 月 17 日 (一) 至 10 月 1 日 (一)\n" +
                "\n" +
                "『物靈附身 ‧ 暗』－9 月 24 日 (一) 至 10 月 7 日 (日)\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第八彈：體力滿滿\n" +
                "\n" +
                "第一段時間：8 月 27 日 (一) 至 8 月 28 日 (二)\n" +
                "\n" +
                "第二段時間：8 月 29 日 (三) 至 8 月 30 日 (四)\n" +
                "\n" +
                "於指定時段首次使用魔法石回復體力，將可額外獲得體力回復劑 1 支(無使用期限)，兩個時段共可獲得回復劑 2 支。\n" +
                "\n" +
                " \n" +
                "\n" +
                "★ 第九彈：『奧羅茲遺族』系列任務再續\n" +
                ...
                "開放關卡：『救助所有生命』\n" +
                "\n" +
                "時間：8 月 27 日 (一) 至 9 月 16 日 (日)\n" +
                "\n" +
                "註:\n" +
                "\n" +
                "1.『救助所有生命』關卡設有精英級難度，成功通過後關卡 BOSS 100% 掉落！\n" +
                "\n" +
                "精英級的開放條件為擁有該王關角色，並成功通過超級難度關卡。\n" +
                "精英級關卡將不設成就及排行榜。\n" +
                "系列關卡設有「指定場次獎勵」，通關達指定次數後可獲額外獎賞。\n" +
                ...
                "時間：9 月 1 日 (六) 至 9 月 2 日 (日)\n" +
                "\n" +
                "活動期間，挑戰公會任務『瘋臨茶居』關卡，亂入角色出現率將會提升！";
        lines = data.split("\n");
